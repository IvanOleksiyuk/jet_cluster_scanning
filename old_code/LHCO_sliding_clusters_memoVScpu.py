...
W=250
k=50
retrain=2 #rettrain 0= no retraining, 1 with the parameterrs of the first training, 2 with the parameters of the last step
steps=50
...
if not retrain:
    ...
    print("first_tr_data done --- %s seconds ---" % (time.time() - start_time_glb))
