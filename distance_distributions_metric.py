...
for repr_name, reprocessing in zip(repr_names, reprocessings):
    ...
    plt.savefig("plots/dist_distributions/{:}{:}pix.png".format(repr_name, pix), bbox_inches="tight")
        ...
        for prep in list_prepr_names:
            for sigma in list_sigma:
                ...
                if comb=="one-jet":
                    ...
                    metric.append(get_metric_from_res(res, metric_name, "_mean"))
                elif comb=="max":
                    metric.append(get_metric_from_res(res, metric_name, "_max"))
        pass
