...
plt.figure()
plt.grid()
plt.plot(X_embedded[:, 0][kmeans.labels_==1], X_embedded[:, 1][kmeans.labels_==1], ".", color="red")
plt.plot(X_embedded[:, 0][kmeans.labels_==0], X_embedded[:, 1][kmeans.labels_==0], ".", color="blue")
