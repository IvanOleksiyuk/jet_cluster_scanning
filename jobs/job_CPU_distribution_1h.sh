...
#SBATCH --output=outputs/output_DISTRIBUTION_%J.txt
...
#python t_statistic_distribution.py config/distribution/responce/prep05_1_maxdev3_msdersCURTAINS_15mean_sig_reg.yaml config/distribution/responce/bootstrap_sig_contam_all_sig_reg.yaml test/config/plot_path2.yaml
python t_statistic_distribution.py config/distribution/responce/prep05_1_maxdev3_msdersCURTAINS_15mean_ignore_signal.yaml config/distribution/v4/bootstrap_sig_contam_ignore_signal.yaml test/config/plot_path2.yaml
#sh export_bres.sh 
