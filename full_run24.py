...
for dataset_label, reproc_label in zip(dataset_label_list, reproc_label_list):
    ...
    for SCORE_TYPE in SCORE_TYPE_true_names_list:
        names.append("char/other-s/{:}m100s0c100r{:}KId0{:}".format(dataset_label, reproc_label, SCORE_TYPE))
...
for SCORE_TYPE in SCORE_TYPE_true_names_list:
    for i in range(len(dataset_list)):
        shutil.copy("char/other-s/{:}m100s0c100r{:}KId0{:}/".format(dataset_label_list[i], reproc_label_list[i], SCORE_TYPE)+"res.pickle", output_folder+"ROC_pickles/ROC_{:}_{:}".format(dataset_label_list[i], SCORE_TYPE))
...
shutil.copy("char/other-s/QCDh5+toph5m100s0c100rnoneKId0logLds/dimensions.png", output_folder+"dimensions.png")
